...
const SEV = {
  ...
  ok:       { Icon: CheckCircle,   color: 'text-violet-600',   bg: 'bg-violet-50 border-violet-200'   },
}
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-3 sm:p-6">
      ...
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 bg-gradient-to-l from-violet-50 to-white">
          <div>
        ...
        {hasActionable && (
          <div className="px-4 pb-4 pt-2 border-t border-gray-100">
            ...
            <Link
              ...
              onClick={onClose}
              className="flex items-center justify-center gap-2 w-full py-3 bg-violet-600 text-white rounded-xl hover:bg-violet-700 transition-colors font-semibold text-sm"
            >
              <Zap size={15} />
